...
| A 유형 | B 제목 | C 작가/설명 | D 팔레트 | E 에디션 | F 상태 | G URL | H 완료일 | I 자료 |
|---|---|---|---|---|---|---|---|---|
...
> - 완료 / 실패: 시스템이 자동 기록
>
> 📂 **정보가 적은 신간 — 자료(I열)**: 책소개·목차·서평을 **구글독스**에 정리하고 문서를 공유(링크 있는 모든 사용자·뷰어)한 뒤 그 URL을 I열에 붙여넣으면, 그 자료 범위 안에서만 출제합니다 (지어내기 방지). 자료가 준비될 때까지는 상태를 "중지"로 두세요. (리포의 `자료/책제목.md` 파일 방식도 백업 경로로 계속 동작)
